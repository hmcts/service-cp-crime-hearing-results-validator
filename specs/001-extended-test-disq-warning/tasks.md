...
- [X] T129 [VAL] [P] Run the `spec-validator` reviewer agent against `src/main/resources/rules/DR-DISQ-001.yaml` (no schema change — still expected COMPLIANT) plus any updated YAML. Result: COMPLIANT — all 6 checks passed.
