...
class CommunityOrderEndDatePreprocessorTest {
    ...
    class YroConfiguration {
        ...
        @Test
        @DisplayName("AC2b — YRC1 endDateOfTagging after YRONI end date produces cureViolationCount 1")
        ...
        @Test
        @DisplayName("AC2c — YRC3 end date after YROFEW end date produces curaViolationCount 1")
        ...
        @Test
        @DisplayName("AC2 — YROISS with no curfew child requirements: all violation counts zero")
        ...
        @Test
        @DisplayName("AC3 — YRUP1 with order under 12 months produces upwrViolationCount 1")
        ...
        @Test
        @DisplayName("AC3 — YRUP1 at boundary (hearingDay + 12m − 1d = 2027-05-19): no violation")
        ...
        @Test
        @DisplayName("AC3 — YROINI without YRUP1: upwrViolationCount is zero")
