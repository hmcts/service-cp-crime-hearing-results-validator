 ...
 *   <li>{@code $.warnings[?(@.ruleId=='DR-CTL-003')]} is the expected size for this rule.</li>
...
class CtlMissingWarningIntegrationTest extends IntegrationTestBase {
    ...
    class WarnsWhenAllConditionsMet {
        ...
        void ri_result_no_existing_ctl_no_ctl_result_not_convicted_should_produce_warning()
            ...
            mockMvc.perform(post(VALIDATE_URL)
                    ...
                    .andExpect(jsonPath("$.warnings[0].ruleId", is("DR-CTL-003")))
    ...
    class BypassConditionsSuppressWarning {
        ...
        @Test
        void ctl_short_code_in_current_hearing_should_suppress_warning() throws Exception {
            String request = """
                    {
                      "hearingId": "h1",
                      "hearingDay": "2026-05-06",
        ...
        @Test
        void ctldate_prompt_on_the_remand_result_line_should_suppress_warning() throws Exception {
            String request = """
                    {
                      "hearingId": "h1",
                      "hearingDay": "2026-05-06",
                      ...
                      "resultLines": [
                        {"resultLineId": "rl1", "shortCode": "RI", "label": "Remand in custody",
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "CTLDATE", "promptValue": "2026-05-06"}]}
                      ],
                      "defendants": [{"defendantId": "d1", "firstName": "Alex", "lastName": "Jones"}],
                      "offences": [
                        {"offenceId": "off1", "offenceCode": "TH68001", "offenceTitle": "Theft",
