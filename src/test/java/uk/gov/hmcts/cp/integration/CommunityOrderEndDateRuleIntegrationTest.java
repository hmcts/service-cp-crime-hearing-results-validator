 ...
 *
 * <p>DR-COEW-005 defaults to enabled by its Flyway seed migration and nothing else in the test
 ...
 * <ul>
 *   <li>{@code $.warnings} is empty (DR-COEW-005 produces ERRORs only).</li>
 *   <li>{@code $.errors.validationIssues[?(@.ruleId=='DR-COEW-005')]} has the expected size.</li>
...
class CommunityOrderEndDateRuleIntegrationTest extends IntegrationTestBase {
    ...
    private static final String DR_COEW_ERRORS = "$.errors.validationIssues[?(@.ruleId=='DR-COEW-005')]";
    ...
    class Scenario6 {
        ...
        void coew_with_cur_ending_after_order_should_produce_cur_error() throws Exception {
            ...
            mockMvc.perform(post(VALIDATE_URL)
                    ...
                    .andExpect(jsonPath("$.errors.validationIssues[0].ruleId", is("DR-COEW-005")))
        ...
        void coew_with_cur_and_aar_both_violating_should_produce_two_separate_errors()
            ...
            mockMvc.perform(post(VALIDATE_URL)
                    ...
                    .andExpect(jsonPath("$.errors.validationIssues[*].ruleId",
                            containsInAnyOrder("DR-COEW-005", "DR-COEW-005")));
        }
    }
    ...
    class ErrorSummaryResponseStructure {
        ...
        @Test
        void multiple_distinct_ac2_errors_both_appear_in_response() throws Exception {
            // d1 → CUR violation (AC2a), d2 → AAR violation (AC2d)
            String request = """
                    {
                      "hearingId": "h-t13b",
                      "hearingDay": "2026-01-01",
                      ...
                      "resultLines": [
                        ...
                        {"resultLineId": "rl-d2-aar", "shortCode": "AAR", "category": "I", "label": "Requirement",
                         "defendantId": "d2", "offenceId": "off2",
                         "prompts": [{"promptRef": "until", "promptValue": "2027-02-01"}]}
                      ],
                      "defendants": [
                        {"defendantId": "d1", "firstName": "CUR", "lastName": "Defendant"},
            ...
            mockMvc.perform(post(VALIDATE_URL)
                    ...
                    .andExpect(jsonPath("$.errors.errorMessages",
                            containsInAnyOrder(
                                    ERR_MSG_BASE_CUR + "CUR Defendant.",
                                    ERR_MSG_BASE_AAR + "AAR Defendant.")));
        }
    }
    ...
    class InlineErrorOffenceScoping {
        ...
        @Test
        void multiple_ac2_violations_each_error_scoped_to_its_own_offence() throws Exception {
            // off1 → CUR violation (AC2a); off2 → AAR violation (AC2d)
            String request = """
                    {
                      "hearingId": "h-t14b",
                      "hearingDay": "2026-01-01",
                      ...
                      "resultLines": [
                        ...
                        {"resultLineId": "rl-o2-order", "shortCode": "COEW", "category": "F", "label": "Community order",
                         "defendantId": "d1", "offenceId": "off2",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2027-01-01"}]},
                        {"resultLineId": "rl-o2-aar", "shortCode": "AAR", "category": "I", "label": "Requirement",
                         "defendantId": "d1", "offenceId": "off2",
                         "prompts": [{"promptRef": "until", "promptValue": "2027-02-01"}]}
                      ],
