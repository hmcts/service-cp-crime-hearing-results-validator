...
class CommunityOrderEndDateRuleIntegrationTest extends IntegrationTestBase {
    ...
    // ═════════════════════════════════════════════════════════════════════════
    // AC4 — Defendant attribution in error response ("This affects: …")
    // ═════════════════════════════════════════════════════════════════════════

    /**
     * AC4 requires the UI to render "This affects: &lt;&lt;defendant name&gt;&gt;" beneath each
     * error. The UI derives the name from {@code affectedDefendants[].defendantId} by looking up
     * the hearing's defendants list it already holds. These tests verify the API response carries
     * the correct defendant ID on every DR-COEW-001 issue.
     */
    @Nested
    @DisplayName("AC4 — Defendant attribution in error response")
    class Ac4DefendantAttribution {

        @Test
        void single_defendant_cur_violation_response_includes_defendant_id() throws Exception {
            // COEW order end 30/10/2026, CUR ends 30/11/2026 → CUR violation for d1
            String request = """
                    {
                      "hearingId": "h-ac4a",
                      "hearingDay": "2026-01-01",
                      "courtType": "MAGISTRATES",
                      "resultLines": [
                        {"id": "rl-order", "shortCode": "COEW", "category": "F",
                         "label": "Community order",
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-10-30"}]},
                        {"id": "rl-cur", "shortCode": "CUR", "category": "I",
                         "label": "Requirement",
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-11-30"}]}
                      ],
        ...
        @Test
        void two_defendants_same_violation_type_each_error_attributes_correct_defendant()
                throws Exception {
            // Both d1 and d2 have CUR violations on their own offences.
            // Expected: 2 separate DR-COEW-001 errors, each attributing its own defendant.
            String request = """
                    {
                      "hearingId": "h-ac4b",
                      "hearingDay": "2026-01-01",
                      "courtType": "MAGISTRATES",
                      "resultLines": [
                        {"id": "rl-d1-order", "shortCode": "COEW", "category": "F",
                         "label": "Community order",
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-10-30"}]},
                        {"id": "rl-d1-cur", "shortCode": "CUR", "category": "I",
                         "label": "Requirement",
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-11-30"}]},
                        {"id": "rl-d2-order", "shortCode": "COEW", "category": "F",
                         "label": "Community order",
                         "defendantId": "d2", "offenceId": "off2",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-09-30"}]},
                        {"id": "rl-d2-cur", "shortCode": "CUR", "category": "I",
                         "label": "Requirement",
                         "defendantId": "d2", "offenceId": "off2",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2026-11-30"}]}
                      ],
                      "defendants": [
                        {"id": "d1", "firstName": "John", "lastName": "Smith"},
                        {"id": "d2", "firstName": "Jane", "lastName": "Doe"}
                      ],
                      "offences": [
                        {"id": "off1", "offenceCode": "TH68001",
                         "offenceTitle": "Theft", "orderIndex": 1},
        ...
        @Test
        void ac3_upwr_violation_response_includes_defendant_id() throws Exception {
            // COEW order end 13/04/2027, hearing 14/05/2026 → UPWR < 12 months for d1
            String request = """
                    {
                      "hearingId": "h-ac4c",
                      "hearingDay": "2026-05-14",
                      ...
                      "resultLines": [
                        {"id": "rl-order", "shortCode": "COEW", "category": "F",
                         ...
                         "defendantId": "d1", "offenceId": "off1",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2027-04-13"}]},
                        {"id": "rl-upwr", "shortCode": "UPWR", "category": "I",
                         "label": "Requirement",
                         "defendantId": "d1", "offenceId": "off1"}
                      ],
                      "defendants": [{"id": "d1", "firstName": "Unpaid", "lastName": "Worker"}],
                      "offences": [{"id": "off1", "offenceCode": "TH68001",
                                    "offenceTitle": "Theft", "orderIndex": 1}]
                    }
                    """;
        ...
        @Test
        void mixed_ac2_ac3_errors_each_carry_the_correct_defendant_id() throws Exception {
            // d1 → CUR violation (AC2a), d2 → UPWR too short (AC3)
            // Each error must attribute its own defendant only.
            String request = """
                    {
                      "hearingId": "h-ac4d",
                      "hearingDay": "2026-05-14",
                      ...
                      "resultLines": [
                        ...
                        {"id": "rl-d2-order", "shortCode": "COEW", "category": "F",
                         ...
                         "defendantId": "d2", "offenceId": "off2",
                         "prompts": [{"promptRef": "endDate", "promptValue": "2027-04-13"}]},
                        {"id": "rl-d2-upwr", "shortCode": "UPWR", "category": "I",
                         "label": "Requirement",
                         "defendantId": "d2", "offenceId": "off2"}
                      ],
                      "defendants": [
